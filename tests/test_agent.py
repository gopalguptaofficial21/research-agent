...
class TestSearchArxiv:
    ...
    def test_paper_has_required_keys(self):
        ...
        if results:
            paper = results[0]
            for key in ["title", "authors", "abstract", "pdf_url", "arxiv_id", "published"]:
...
class TestBuildVectorStore:
    def test_returns_faiss_store(self):
        ...
        papers = [{
            ...
            "full_text": "This is a test paper about machine learning and neural networks. " * 10,
        }]
...
class TestAskQuestion:
    def test_returns_answer_and_sources(self):
        ...
        docs = [Document(
            ...
            metadata={"title": "Attention Paper", "arxiv_id": "1706.03762",
                      "authors": "Vaswani et al.", "url": "https://arxiv.org/abs/1706.03762"},
        )]
